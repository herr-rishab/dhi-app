...
class _CreateTicketWidgetState extends State<CreateTicketWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'createTicket'});
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'nz7upv81' /* tell us about your issue */,
                      ),
                      style:
                      ...
                      children: [
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: FFLocalizations.of(context).getText(
                              'j4sbqrhm' /* Enter the subject of your issu... */,
                            ),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              '6vxop8gz' /* Provide a detailed description... */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '2ysk6z2x' /* Upload Screenshot (Optional) */,
                                  ),
